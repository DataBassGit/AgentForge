...
def test_agent_registry_build_agents_with_template_file(minimal_agent_config):
    ...
    agent_def = CogAgentDef(id="test_agent", template_file="custom_template", type="agentforge.agent.Agent")

    cog_def = CogDefinition(name="test_cog", agents=[agent_def], flow=None)
...
def test_agent_registry_build_agents_multiple(minimal_agent_config):
    ...
    cog_def = CogDefinition(name="test_cog", agents=agent_defs, flow=None)
