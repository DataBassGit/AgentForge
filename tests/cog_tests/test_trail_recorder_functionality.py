...
class TestTrailRecorderFunctionality:
    ...
    def test_thought_trail_entry_optional_fields(self):
        ...
        entry = ThoughtTrailEntry(
            agent_id="test_agent", output="test_output", notes="Test notes", execution_order=5, error="Test error"
        )
    ...
    def test_cog_trail_integration(self, isolated_config):
        ...
        cog.agents["test_agent"] = Mock(run=Mock(return_value="Test simulated response"))
