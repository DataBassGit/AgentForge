...
class Agent:
    ...
    def run(self, **kwargs: Any) -> Optional[str]:
        ...
        """
        try:
            self.logger.log(f"{self.agent_name} - Running...", 'info')
            ...
            self.build_output()
            self.logger.log(f"{self.agent_name} - Done!", 'info')
    ...
    def load_prompt_template(self) -> None:
        ...
        self.logger.log(f"Prompts for '{self.agent_name}' validated.", 'debug')
    ...
    def load_persona_data(self) -> None:
        ...
        if personas_enabled:
            ...
            self.logger.log(f"Persona Data Loaded for '{self.agent_name}'.", 'debug')
    ...
    def validate_persona_data(self) -> None:
        ...
        """
        if not self.persona:
            self.logger.log(f"Personas are enabled but no persona data found for agent '{self.agent_name}'.", 'warning')

        self.logger.log(f"Persona for '{self.agent_name}' validated!.", 'debug')
