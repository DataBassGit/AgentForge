...
class ScratchPad(Memory):
    ...
    def __init__(self, cog_name: str, persona: str | None = None, collection_id: str | None = None):
        """
    ...
    def _save_scratchpad_log(self, content: str) -> None:
        ...
        self.logger.debug(f"Saving to Scratchpad Log: {self.log_collection_name}\nContent: {content}\nID: {memory_id}")
    ...
    def _save_main_scratchpad(self, content: str) -> None:
        ...
        """
        self.logger.debug(f"Updating main scratchpad: {self.collection_name}\nContent: {content[:100]}...")
    ...
    def check_scratchpad(self) -> str | None:
        """
        ...
        if log_count >= 20:
            self.logger.debug("Scratchpad log count >= 20, updating scratchpad")
            ...
            agent_vars = {"scratchpad_log": scratchpad_log_content, "scratchpad": current_scratchpad}
            scratchpad_result = scratchpad_agent.run(**agent_vars)
            if scratchpad_result is None:
                scratchpad_result = ""
            ...
            self.logger.debug("Cleared scratchpad log")
    ...
    def delete(self, ids: Union[str, list[str]] | None = None) -> None:
        """
        ...
        self.storage.delete_collection(self.log_collection_name)
        self.logger.debug("Deleted scratchpad and log collections")
